...
from tensorflow.keras.layers import Input, Dropout, Dense, BatchNormalization, concatenate, Lambda, LeakyReLU, ReLU
import numpy as np
...
def RamanNet(w_len, n_windows, n_classes):
    ...
    for i in range(n_windows):
        ...
        #feat = LeakyReLU()(top)#Not supported in SHAP
        feat = ReLU()(feat)#for SHAP
    ...
    #top = LeakyReLU()(top)#Not supported in SHAP
    top = ReLU()(top)#for SHAP
